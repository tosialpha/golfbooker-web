...
const translations = {
  en: {
    ...
    'faq.a2': 'Täydellinen varausjärjestelmä, verkkolähtöajat, asiakastietokanta, automaattiset vahvistukset, liikevaihtoanalytiikka, mobiilisovellus asiakkaillesi, verkkosivuintegraatio ja jatkuva tuki.',
    'faq.q3': 'Kuinka kauan käyttöönotto kestää?',
    'faq.a3': 'Useimmat kentät ovat valmiina 1-2 viikossa. Hoidamme tietojen siirron, henkilöstön koulutuksen ja tarjoamme täyden tuen siirtymävaiheessa vanhasta järjestelmästä.',
    'faq.q4': 'Voimmeko siirtyä NexGolfista tai muusta järjestelmästä?',
    'faq.a4': 'Kyllä! Erikoistumme auttamaan kenttiä siirtymään NexGolfista ja muista vanhoista järjestelmistä. Tuomme asiakastietonne, varaushistorian ja varmistamme sujuvan siirtymän.',
