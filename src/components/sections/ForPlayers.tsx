    ...
    <section className="py-20 md:py-32 bg-white">
      <Container>
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            <div className="w-64 sm:w-72 md:w-80 bg-gray-900 rounded-[2.5rem] sm:rounded-[3rem] shadow-2xl p-2 relative mx-auto">
            ...
            <div className="hidden sm:block absolute -top-6 -right-6 w-24 h-24 bg-brand-green-300 rounded-2xl blur-2xl opacity-50"></div>
            <div className="hidden sm:block absolute -bottom-6 -left-6 w-32 h-32 bg-green-200 rounded-2xl blur-2xl opacity-40"></div>
          </motion.div>
        </div>
      </Container>
    </section>
