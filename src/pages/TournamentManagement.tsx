        ...
        <Container>
          ...
          >
            ...
            <motion.div
              ...
              className="absolute bottom-0 right-2 top-0 md:relative md:bottom-auto md:right-auto md:top-auto md:-ml-16 z-10 flex items-center justify-center"
            >
              <div className="aspect-[9/19] h-full md:h-auto md:w-52 lg:w-64 bg-gray-900 rounded-[1.5rem] sm:rounded-[1.75rem] md:rounded-[2.5rem] shadow-2xl p-1 sm:p-1.5 md:p-2 relative">
